...
{
    DeviceId = Environment.GetEnvironmentVariable("INSTALL_ID") ?? "aconsulting-dev-1",
...
Console.WriteLine($"AConsulting BridgeHost syncReady={cfg.SyncReady} hasToken={cfg.HasSyncToken} hub={cfg.HubUrl}");
